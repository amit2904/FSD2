...
Right click → Inspect Inspect
OR Press F12
Edge Developer Tools will open 
6.2 Network Analysis (No Throttling)
Open Network tab
Reload page Elements Tab
6.3 Elements Inspection
Inspect DOM structure
Analyze JS, XHR, images, fonts, API Calls Performance Timeline Core Web Vitals
6.4 Core Web Vitals
...
Open Lighthouse tab
Run audit (Desktop)  Performance Score: 95
Accessibility: 90
Best Practices: 96
SEO: 91
...
Reload page
Observe delayed loading Network Throttling - 3G
6.8 Disable Cache Test
Enable Disable Cache
Reload page
Compare load times With Cache Disable Cache
6.9 Memory Analysis
Open Memory tab
Take Heap Snapshot
Observe memory usage Memory Tab
6.10 Sources Tab
View loaded scripts and source mapping Sources Tab
Learning Outcome
